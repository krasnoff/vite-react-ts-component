        ...
        <div className="wrapper">
          <div className="App">
            ...
            <h1 id="accessibilitycomponent">AccessibilityComponent</h1>
              ...
              <p>Using <code>AccessibilityComponent</code> alone does not guarantee full accessibility compliance. It is the responsibility of developers to build their web applications following the <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" className="black">WCAG</a> accessibility standards. This includes proper semantic HTML, keyboard navigability, sufficient color contrast, and providing alternative text for images, among other requirements.</p>
              <p>For comprehensive guidance on making your website accessible, refer to the official <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" className="black">WCAG</a> guidelines.</p>
